...
/// Orchestration and serialization glue logic for `PutResourcePermissionStatement`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct PutResourcePermissionStatement;
impl PutResourcePermissionStatement {
    /// Creates a new `PutResourcePermissionStatement`
    pub fn new() -> Self {
        Self
    }
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::put_resource_permission_statement::PutResourcePermissionStatementError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::put_resource_permission_statement::PutResourcePermissionStatementOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.service" = "Signin",
            "rpc.method" = "PutResourcePermissionStatement",
    ...
    pub(crate) fn operation_runtime_plugins(
        ...
        runtime_plugins = runtime_plugins.with_operation_plugin(crate::client_idempotency_token::IdempotencyTokenRuntimePlugin::new(
            |token_provider, input| {
                let input: &mut crate::operation::put_resource_permission_statement::PutResourcePermissionStatementInput =
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutResourcePermissionStatement {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("PutResourcePermissionStatement");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            PutResourcePermissionStatementRequestSerializer,
        ));
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
                PutResourcePermissionStatementResponseDeserializer,
            ),
        );
        ...
        cfg.store_put(
            ::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
                crate::config::auth::Params::builder()
                    .operation_name("PutResourcePermissionStatement")
                    .build()
    ...
    fn runtime_components(
        ...
        .with_interceptor(
            ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                PutResourcePermissionStatementEndpointParamsInterceptor,
            ),
        )
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for PutResourcePermissionStatementTelemetryInputCaptureInterceptor
{
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<PutResourcePermissionStatementInput>()
        else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for PutResourcePermissionStatementResponseDeserializer
{
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_put_resource_permission_statement::de_put_resource_permission_statement_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_put_resource_permission_statement::de_put_resource_permission_statement_http_response(status, headers, body)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct PutResourcePermissionStatementRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutResourcePermissionStatementRequestSerializer {
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::put_resource_permission_statement::PutResourcePermissionStatementInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::put_resource_permission_statement::PutResourcePermissionStatementInput,
                output: &mut ::std::string::String,
            ) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/put-resource-permission-statement").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_put_resource_permission_statement::ser_put_resource_permission_statement_input(&input)?,
        );
...
#[derive(Debug)]
struct PutResourcePermissionStatementEndpointParamsInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for PutResourcePermissionStatementEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "PutResourcePermissionStatementEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<PutResourcePermissionStatementInput>()
            .ok_or("failed to downcast to PutResourcePermissionStatementInput")?;
...
/// Error type for the `PutResourcePermissionStatementError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum PutResourcePermissionStatementError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-PutResourcePermissionStatementError) for what information is available for the error."
    )]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl PutResourcePermissionStatementError {
    /// Creates the `PutResourcePermissionStatementError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `PutResourcePermissionStatementError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `PutResourcePermissionStatementError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `PutResourcePermissionStatementError::ConflictException`.
    pub fn is_conflict_exception(&self) -> bool {
        matches!(self, Self::ConflictException(_))
    }
    /// Returns `true` if the error kind is `PutResourcePermissionStatementError::InternalServerException`.
    pub fn is_internal_server_exception(&self) -> bool {
        matches!(self, Self::InternalServerException(_))
    }
    /// Returns `true` if the error kind is `PutResourcePermissionStatementError::ServiceQuotaExceededException`.
    pub fn is_service_quota_exceeded_exception(&self) -> bool {
        matches!(self, Self::ServiceQuotaExceededException(_))
    }
    /// Returns `true` if the error kind is `PutResourcePermissionStatementError::TooManyRequestsError`.
    pub fn is_too_many_requests_error(&self) -> bool {
        matches!(self, Self::TooManyRequestsError(_))
    }
    /// Returns `true` if the error kind is `PutResourcePermissionStatementError::ValidationException`.
    pub fn is_validation_exception(&self) -> bool {
        matches!(self, Self::ValidationException(_))
    }
}
impl ::std::error::Error for PutResourcePermissionStatementError {
...
impl ::std::fmt::Display for PutResourcePermissionStatementError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for PutResourcePermissionStatementError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for PutResourcePermissionStatementError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for PutResourcePermissionStatementError {
...
impl ::aws_types::request_id::RequestId
    for crate::operation::put_resource_permission_statement::PutResourcePermissionStatementError
{
...
pub use crate::operation::put_resource_permission_statement::_put_resource_permission_statement_input::PutResourcePermissionStatementInput;

pub use crate::operation::put_resource_permission_statement::_put_resource_permission_statement_output::PutResourcePermissionStatementOutput;

mod _put_resource_permission_statement_input;

mod _put_resource_permission_statement_output;
