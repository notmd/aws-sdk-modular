...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for DeleteCustomKeyStoreTelemetryInputCaptureInterceptor
{
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteCustomKeyStoreResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_delete_custom_key_store::de_delete_custom_key_store_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_custom_key_store::de_delete_custom_key_store_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteCustomKeyStoreRequestSerializer {
    ...
    > {
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_delete_custom_key_store::ser_delete_custom_key_store_input(&input)?,
        );
...
impl DeleteCustomKeyStoreError {
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::CustomKeyStoreHasCmKsException(e) => {
