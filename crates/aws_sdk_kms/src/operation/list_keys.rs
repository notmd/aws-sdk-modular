    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_keys::ListKeysError>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListKeys {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListKeysResponseDeserializer),
        );
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListKeysRequestSerializer {
    ...
    > {
        let input = input
            .downcast::<crate::operation::list_keys::ListKeysInput>()
            .expect("correct type");
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_list_keys::ser_list_keys_input(&input)?,
        );
