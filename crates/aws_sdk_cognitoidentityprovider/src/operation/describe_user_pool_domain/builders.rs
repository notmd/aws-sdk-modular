...
impl crate::operation::describe_user_pool_domain::builders::DescribeUserPoolDomainInputBuilder {
    ...
    pub async fn send_with(
        ...
        >,
    > {
        let mut fluent_builder = client.describe_user_pool_domain();
...
/// <p>This operation doesn't return results when you query a prefix domain in a secondary Region. Prefix domains are Region-specific and can only be described in the Region where they were created. To describe a prefix domain for a replica user pool, make the request to the primary Region's endpoint.</p>
/// </note> <note>
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::describe_user_pool_domain::DescribeUserPoolDomainOutput,
        crate::operation::describe_user_pool_domain::DescribeUserPoolDomainError,
    > for DescribeUserPoolDomainFluentBuilder
{
    fn send(
        self,
...
impl DescribeUserPoolDomainFluentBuilder {
    /// Creates a new `DescribeUserPoolDomainFluentBuilder`.
