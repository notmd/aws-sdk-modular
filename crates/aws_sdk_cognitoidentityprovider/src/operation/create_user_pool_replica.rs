...
/// Orchestration and serialization glue logic for `CreateUserPoolReplica`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct CreateUserPoolReplica;
impl CreateUserPoolReplica {
    /// Creates a new `CreateUserPoolReplica`
    pub fn new() -> Self {
        Self
    }
    pub(crate) async fn orchestrate(
        runtime_plugins: &::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugins,
        input: crate::operation::create_user_pool_replica::CreateUserPoolReplicaInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_user_pool_replica::CreateUserPoolReplicaError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_user_pool_replica::CreateUserPoolReplicaOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Cognito Identity Provider.CreateUserPoolReplica",
            "rpc.service" = "Cognito Identity Provider",
            "rpc.method" = "CreateUserPoolReplica",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateUserPoolReplica {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateUserPoolReplica");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreateUserPoolReplicaRequestSerializer,
        ));
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
                CreateUserPoolReplicaResponseDeserializer,
            ),
        );
        ...
        cfg.store_put(
            ::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
                crate::config::auth::Params::builder()
                    .operation_name("CreateUserPoolReplica")
                    .build()
    ...
    fn runtime_components(
        ...
        .with_interceptor(
            ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CreateUserPoolReplicaTelemetryInputCaptureInterceptor,
            ),
        )
        .with_interceptor(
            ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
        ...
        .with_interceptor(
            ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CreateUserPoolReplicaEndpointParamsInterceptor,
            ),
        )
...
#[derive(Debug)]
struct CreateUserPoolReplicaTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for CreateUserPoolReplicaTelemetryInputCaptureInterceptor
{
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CreateUserPoolReplicaInput>() else {
...
#[derive(Debug)]
struct CreateUserPoolReplicaResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateUserPoolReplicaResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_user_pool_replica::de_create_user_pool_replica_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_user_pool_replica::de_create_user_pool_replica_http_response(
                status, headers, body,
            )
        };
...
#[derive(Debug)]
struct CreateUserPoolReplicaRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateUserPoolReplicaRequestSerializer {
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::create_user_pool_replica::CreateUserPoolReplicaInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::create_user_pool_replica::CreateUserPoolReplicaInput,
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AWSCognitoIdentityProviderService.CreateUserPoolReplica",
            );
            builder
        };
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_create_user_pool_replica::ser_create_user_pool_replica_input(&input)?,
        );
...
#[derive(Debug)]
struct CreateUserPoolReplicaEndpointParamsInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateUserPoolReplicaEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "CreateUserPoolReplicaEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<CreateUserPoolReplicaInput>()
            .ok_or("failed to downcast to CreateUserPoolReplicaInput")?;
...
/// Error type for the `CreateUserPoolReplicaError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum CreateUserPoolReplicaError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateUserPoolReplicaError) for what information is available for the error."
    )]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl CreateUserPoolReplicaError {
    /// Creates the `CreateUserPoolReplicaError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `CreateUserPoolReplicaError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `CreateUserPoolReplicaError::FeatureUnavailableInTierException`.
    pub fn is_feature_unavailable_in_tier_exception(&self) -> bool {
        matches!(self, Self::FeatureUnavailableInTierException(_))
    }
    /// Returns `true` if the error kind is `CreateUserPoolReplicaError::InternalErrorException`.
    pub fn is_internal_error_exception(&self) -> bool {
        matches!(self, Self::InternalErrorException(_))
    }
    /// Returns `true` if the error kind is `CreateUserPoolReplicaError::InvalidParameterException`.
    pub fn is_invalid_parameter_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterException(_))
    }
    /// Returns `true` if the error kind is `CreateUserPoolReplicaError::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(self, Self::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `CreateUserPoolReplicaError::NotAuthorizedException`.
    pub fn is_not_authorized_exception(&self) -> bool {
        matches!(self, Self::NotAuthorizedException(_))
    }
    /// Returns `true` if the error kind is `CreateUserPoolReplicaError::OperationNotEnabledException`.
    pub fn is_operation_not_enabled_exception(&self) -> bool {
        matches!(self, Self::OperationNotEnabledException(_))
    }
    /// Returns `true` if the error kind is `CreateUserPoolReplicaError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `CreateUserPoolReplicaError::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(self, Self::TooManyRequestsException(_))
    }
    /// Returns `true` if the error kind is `CreateUserPoolReplicaError::UserPoolTaggingException`.
    pub fn is_user_pool_tagging_exception(&self) -> bool {
        matches!(self, Self::UserPoolTaggingException(_))
    }
}
impl ::std::error::Error for CreateUserPoolReplicaError {
...
impl ::std::fmt::Display for CreateUserPoolReplicaError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for CreateUserPoolReplicaError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateUserPoolReplicaError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::FeatureUnavailableInTierException(_inner) => {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateUserPoolReplicaError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_user_pool_replica::CreateUserPoolReplicaError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use crate::operation::create_user_pool_replica::_create_user_pool_replica_input::CreateUserPoolReplicaInput;

pub use crate::operation::create_user_pool_replica::_create_user_pool_replica_output::CreateUserPoolReplicaOutput;

mod _create_user_pool_replica_input;

mod _create_user_pool_replica_output;
