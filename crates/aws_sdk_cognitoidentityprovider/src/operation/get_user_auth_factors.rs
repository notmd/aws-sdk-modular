...
/// Orchestration and serialization glue logic for `GetUserAuthFactors`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetUserAuthFactors;
impl GetUserAuthFactors {
    /// Creates a new `GetUserAuthFactors`
    pub fn new() -> Self {
        Self
    }
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_user_auth_factors::GetUserAuthFactorsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_user_auth_factors::GetUserAuthFactorsOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Cognito Identity Provider.GetUserAuthFactors",
            "rpc.service" = "Cognito Identity Provider",
            "rpc.method" = "GetUserAuthFactors",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetUserAuthFactors {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetUserAuthFactors");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetUserAuthFactorsRequestSerializer,
        ));
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
                GetUserAuthFactorsResponseDeserializer,
            ),
        );
        ...
        cfg.store_put(
            ::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
                crate::config::auth::Params::builder()
                    .operation_name("GetUserAuthFactors")
                    .build()
    ...
    fn runtime_components(
        ...
        .with_interceptor(
            ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetUserAuthFactorsEndpointParamsInterceptor,
            ),
        )
...
#[derive(Debug)]
struct GetUserAuthFactorsResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetUserAuthFactorsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_user_auth_factors::de_get_user_auth_factors_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_user_auth_factors::de_get_user_auth_factors_http_response(
                status, headers, body,
            )
        };
...
#[derive(Debug)]
struct GetUserAuthFactorsRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetUserAuthFactorsRequestSerializer {
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::get_user_auth_factors::GetUserAuthFactorsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::get_user_auth_factors::GetUserAuthFactorsInput,
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AWSCognitoIdentityProviderService.GetUserAuthFactors",
            );
            builder
        };
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_get_user_auth_factors::ser_get_user_auth_factors_input(&input)?,
        );
...
#[derive(Debug)]
struct GetUserAuthFactorsEndpointParamsInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetUserAuthFactorsEndpointParamsInterceptor {
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<GetUserAuthFactorsInput>()
            .ok_or("failed to downcast to GetUserAuthFactorsInput")?;
...
/// Error type for the `GetUserAuthFactorsError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum GetUserAuthFactorsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetUserAuthFactorsError) for what information is available for the error."
    )]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl GetUserAuthFactorsError {
    /// Creates the `GetUserAuthFactorsError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `GetUserAuthFactorsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `GetUserAuthFactorsError::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(self, Self::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `GetUserAuthFactorsError::InternalErrorException`.
    pub fn is_internal_error_exception(&self) -> bool {
        matches!(self, Self::InternalErrorException(_))
    }
    /// Returns `true` if the error kind is `GetUserAuthFactorsError::InvalidParameterException`.
    pub fn is_invalid_parameter_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterException(_))
    }
    /// Returns `true` if the error kind is `GetUserAuthFactorsError::NotAuthorizedException`.
    pub fn is_not_authorized_exception(&self) -> bool {
        matches!(self, Self::NotAuthorizedException(_))
    }
    /// Returns `true` if the error kind is `GetUserAuthFactorsError::OperationNotEnabledException`.
    pub fn is_operation_not_enabled_exception(&self) -> bool {
        matches!(self, Self::OperationNotEnabledException(_))
    }
    /// Returns `true` if the error kind is `GetUserAuthFactorsError::PasswordResetRequiredException`.
    pub fn is_password_reset_required_exception(&self) -> bool {
        matches!(self, Self::PasswordResetRequiredException(_))
    }
    /// Returns `true` if the error kind is `GetUserAuthFactorsError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `GetUserAuthFactorsError::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(self, Self::TooManyRequestsException(_))
    }
    /// Returns `true` if the error kind is `GetUserAuthFactorsError::UserNotConfirmedException`.
    pub fn is_user_not_confirmed_exception(&self) -> bool {
        matches!(self, Self::UserNotConfirmedException(_))
    }
    /// Returns `true` if the error kind is `GetUserAuthFactorsError::UserNotFoundException`.
    pub fn is_user_not_found_exception(&self) -> bool {
        matches!(self, Self::UserNotFoundException(_))
    }
}
impl ::std::error::Error for GetUserAuthFactorsError {
...
impl ::std::fmt::Display for GetUserAuthFactorsError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for GetUserAuthFactorsError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetUserAuthFactorsError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetUserAuthFactorsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_user_auth_factors::GetUserAuthFactorsError {
...
mod _get_user_auth_factors_output;
