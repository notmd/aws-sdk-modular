...
/// Orchestration and serialization glue logic for `DeleteTerms`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DeleteTerms;
impl DeleteTerms {
    /// Creates a new `DeleteTerms`
    pub fn new() -> Self {
        Self
    }
    pub(crate) async fn orchestrate(
        runtime_plugins: &::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugins,
        input: crate::operation::delete_terms::DeleteTermsInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::delete_terms::DeleteTermsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::delete_terms::DeleteTermsOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Cognito Identity Provider.DeleteTerms",
            "rpc.service" = "Cognito Identity Provider",
            "rpc.method" = "DeleteTerms",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteTerms {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteTerms");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            DeleteTermsRequestSerializer,
        ));
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteTermsResponseDeserializer),
        );

        cfg.store_put(
            ::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
                crate::config::auth::Params::builder()
                    .operation_name("DeleteTerms")
                    .build()
    ...
    fn runtime_components(
        ...
        .with_interceptor(
            ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                DeleteTermsTelemetryInputCaptureInterceptor,
            ),
        )
        .with_interceptor(
            ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
        ...
        .with_interceptor(
            ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                DeleteTermsEndpointParamsInterceptor,
            ),
        )
...
#[derive(Debug)]
struct DeleteTermsTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteTermsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<DeleteTermsInput>() else {
...
#[derive(Debug)]
struct DeleteTermsResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteTermsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_delete_terms::de_delete_terms_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_delete_terms::de_delete_terms_http_response(status, headers, body)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct DeleteTermsRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteTermsRequestSerializer {
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::delete_terms::DeleteTermsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::delete_terms::DeleteTermsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_delete_terms::ser_delete_terms_input(&input)?,
        );
...
#[derive(Debug)]
struct DeleteTermsEndpointParamsInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteTermsEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "DeleteTermsEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<DeleteTermsInput>()
            .ok_or("failed to downcast to DeleteTermsInput")?;
...
/// Error type for the `DeleteTermsError` operation.
#[non_exhaustive]
...
pub enum DeleteTermsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteTermsError) for what information is available for the error."
    )]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl DeleteTermsError {
    /// Creates the `DeleteTermsError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `DeleteTermsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `DeleteTermsError::ConcurrentModificationException`.
    pub fn is_concurrent_modification_exception(&self) -> bool {
        matches!(self, Self::ConcurrentModificationException(_))
    }
    /// Returns `true` if the error kind is `DeleteTermsError::InternalErrorException`.
    pub fn is_internal_error_exception(&self) -> bool {
        matches!(self, Self::InternalErrorException(_))
    }
    /// Returns `true` if the error kind is `DeleteTermsError::InvalidParameterException`.
    pub fn is_invalid_parameter_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterException(_))
    }
    /// Returns `true` if the error kind is `DeleteTermsError::NotAuthorizedException`.
    pub fn is_not_authorized_exception(&self) -> bool {
        matches!(self, Self::NotAuthorizedException(_))
    }
    /// Returns `true` if the error kind is `DeleteTermsError::OperationNotEnabledException`.
    pub fn is_operation_not_enabled_exception(&self) -> bool {
        matches!(self, Self::OperationNotEnabledException(_))
    }
    /// Returns `true` if the error kind is `DeleteTermsError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `DeleteTermsError::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(self, Self::TooManyRequestsException(_))
    }
}
impl ::std::error::Error for DeleteTermsError {
...
impl ::std::fmt::Display for DeleteTermsError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for DeleteTermsError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeleteTermsError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteTermsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_terms::DeleteTermsError {
