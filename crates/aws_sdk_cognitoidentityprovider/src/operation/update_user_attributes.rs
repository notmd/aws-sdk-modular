...
impl UpdateUserAttributes {
    ...
    > {
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::update_user_attributes::UpdateUserAttributesOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Cognito Identity Provider.UpdateUserAttributes",
            "rpc.service" = "Cognito Identity Provider",
            "rpc.method" = "UpdateUserAttributes",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateUserAttributes {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateUserAttributesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_update_user_attributes::de_update_user_attributes_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_update_user_attributes::de_update_user_attributes_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateUserAttributesRequestSerializer {
    ...
    > {
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_update_user_attributes::ser_update_user_attributes_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateUserAttributesEndpointParamsInterceptor {
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<UpdateUserAttributesInput>()
...
impl UpdateUserAttributesError {
    ...
    /// Creates the `UpdateUserAttributesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `UpdateUserAttributesError::OperationNotEnabledException`.
...
pub use crate::operation::update_user_attributes::_update_user_attributes_input::UpdateUserAttributesInput;

pub use crate::operation::update_user_attributes::_update_user_attributes_output::UpdateUserAttributesOutput;

mod _update_user_attributes_input;

mod _update_user_attributes_output;
