...
/// Configuration for a aws_sdk_cognitoidentityprovider service client.
///
...
impl Builder {
    ...
    /// use aws_sdk_cognitoidentityprovider::config::Config;
    ...
    /// # fn example() {
    /// use std::time::Duration;
    /// use aws_sdk_cognitoidentityprovider::config::{Builder, Config};
    /// use aws_smithy_runtime::client::http::hyper_014::HyperClientBuilder;
    ///
    ...
    /// }
    ///
    /// let mut builder = aws_sdk_cognitoidentityprovider::Config::builder();
    ...
    /// impl aws_sdk_cognitoidentityprovider::config::auth::ResolveAuthScheme for CustomAuthSchemeResolver {
    ///     fn resolve_auth_scheme<'a>(
    ///         &'a self,
    ///         _params: &'a aws_sdk_cognitoidentityprovider::config::auth::Params,
    ///         _cfg: &'a ConfigBag,
    ///         _runtime_components: &'a RuntimeComponents,
    ...
    /// rules for `aws_sdk_cognitoidentityprovider`.
    ///
    ///
    ...
    /// ```no_run
    /// use aws_sdk_cognitoidentityprovider::config::endpoint::{ResolveEndpoint, EndpointFuture, Params, Endpoint};
    /// #[derive(Debug)]
    ...
    /// let config = aws_sdk_cognitoidentityprovider::Config::builder().endpoint_resolver(resolver).build();
    /// let client = aws_sdk_cognitoidentityprovider::Client::from_conf(config);
    /// ```
    ...
    ///
    /// ```no_run
    /// use aws_sdk_cognitoidentityprovider::config::{AsyncSleep, Config, SharedAsyncSleep, Sleep};
    ///
    /// #[derive(Debug)]
    ...
    ///
    /// ```no_run
    /// use aws_sdk_cognitoidentityprovider::config::{AsyncSleep, Builder, Config, SharedAsyncSleep, Sleep};
    ///
    /// #[derive(Debug)]
    /// pub struct ForeverSleep;
    ///
    ...
    /// # Default Behavior
    ///
    /// When no retry partition is explicitly set, the SDK automatically creates a default retry partition named `cognitoidentityprovider`
    /// (or `cognitoidentityprovider-<region>` if a region is configured).
    /// All Cognito Identity Provider clients without an explicit retry partition will share this default partition.
    ///
    /// # Notes
    ///
    ...
    /// ```no_run
    /// use aws_sdk_cognitoidentityprovider::config::Config;
    /// use aws_sdk_cognitoidentityprovider::config::retry::{RetryPartition, TokenBucket};
    ///
    ...
    /// ```no_run
    /// use aws_sdk_cognitoidentityprovider::config::Config;
    /// use aws_sdk_cognitoidentityprovider::config::retry::{ClientRateLimiter, RetryConfig, RetryPartition};
    ///
    ...
    /// ```no_run
    /// use aws_sdk_cognitoidentityprovider::config::IdentityCache;
    ///
    /// let config = aws_sdk_cognitoidentityprovider::Config::builder()
    ...
    /// #    fn meta(&self) -> &aws_sdk_cognitoidentityprovider::error::ErrorMetadata { todo!() }
    /// # }
    ///
    ...
    pub fn disable_clock_skew_correction(
        mut self,
        disable_clock_skew_correction: impl ::std::convert::Into<::std::option::Option<bool>>,
    ) -> Self {
    ...
    pub fn set_disable_clock_skew_correction(
        &mut self,
        disable_clock_skew_correction: ::std::option::Option<bool>,
    ) -> &mut Self {
        self.config
            .store_or_unset::<::aws_runtime::service_clock_skew::DisableClockSkewCorrection>(
                disable_clock_skew_correction.map(Into::into),
            );
        self
    }
    ...
    pub fn build(mut self) -> Config {
        ...
        Config {
            config: crate::config::Layer::from(layer.clone())
                .with_name("aws_sdk_cognitoidentityprovider::config::Config")
                .freeze(),
            cloneable: layer,
...
impl ServiceRuntimePlugin {
    pub fn new(_service_config: crate::config::Config) -> Self {
        let config = {
            let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AWSCognitoIdentityProviderService");
    ...
    pub(crate) fn new(
        ...
        Self {
            config: ::aws_smithy_types::config_bag::Layer::from(layer)
                .with_name("aws_sdk_cognitoidentityprovider::config::ConfigOverrideRuntimePlugin")
                .freeze(),
            components,
        }
    }
...
pub(crate) fn base_client_runtime_plugins(
    ...
    let default_retry_partition = "cognitoidentityprovider";
    ...
    let scope = "aws-sdk-cognitoidentityprovider";
