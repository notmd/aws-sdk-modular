...
impl CreateMultipartUploadFluentBuilder {
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::create_multipart_upload::CreateMultipartUpload::operation_runtime_plugins(
    ...
    /// <p>Specifies the event hold status to apply to the uploaded object. Set to <code>ON</code> to enable or <code>OFF</code> to disable.</p><note>
    /// <p>This functionality is not supported for directory buckets.</p>
    /// </note>
