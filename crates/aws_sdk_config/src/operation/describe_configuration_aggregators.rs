...
impl DescribeConfigurationAggregators {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::describe_configuration_aggregators::DescribeConfigurationAggregatorsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::describe_configuration_aggregators::DescribeConfigurationAggregatorsOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Config Service.DescribeConfigurationAggregators",
            "rpc.service" = "Config Service",
            "rpc.method" = "DescribeConfigurationAggregators",
    ...
    for DescribeConfigurationAggregatorsTelemetryInputCaptureInterceptor
{
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) =
            context.input().downcast_ref::<DescribeConfigurationAggregatorsInput>()
        else {
...
impl DescribeConfigurationAggregatorsError {
    ...
    /// Creates the `DescribeConfigurationAggregatorsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
